...
public class SuperAdminPanel extends javax.swing.JPanel {
    ...
    public SuperAdminPanel(ActionListener logoutButtonListener, ActionListener SelectButtonListener, ActionListener ComboBoxListener, 
...
ActionListener DeleteCursListener, ActionListener DeleteUserListener, ActionListener AddStudentToCursListener, ActionListener DeleteGrupaStudiuListener) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Interfata Super-Administratorului");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Alege tipul utilizatorului", "Student", "Profesor", "Administrator"}));
